    ...
    <div>
       ...
       <div class="row gap-0">
        <div class="col-2 bg-light shadow p-3 " style="height: 100vh;">
            ...
            <a class="p-1 rounded" href="index.cfm?action=overview">Overview</a>
            <a class="p-1 rounded" href="index.cfm?action=posts">Posts</a>
            <a class="p-1 rounded" href="index.cfm?action=categories">Categories</a>
